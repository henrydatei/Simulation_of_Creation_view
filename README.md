...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-13 21:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c0fe6aff-ec9f-4a9b-8283-e0dba73baa61.git
$ cd c0fe6aff-ec9f-4a9b-8283-e0dba73baa61
```
